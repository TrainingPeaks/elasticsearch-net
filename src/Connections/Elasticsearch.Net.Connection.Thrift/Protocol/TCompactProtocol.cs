...
namespace ES.Net.Connection.Thrift.Protocol
{
    public class TCompactProtocol : TProtocol
    {
        ...
        private short _lastFieldId = 0;

        /**
         * If we encounter a boolean field begin, save the TField here so it can
         * have the value incorporated.
         */
        private Nullable<TField> _booleanField;

        /**
         * If we Read a field header, and it's a boolean field, save the boolean
         * value here so that ReadBool can use it.
         */
        private  Nullable<Boolean> _boolValue;
        ...
        */
        ...
        public override void WriteBool(Boolean b)
        {
            if (_booleanField != null)
            {
                ...
                WriteFieldBeginInternal(_booleanField.Value, b ? Types.BOOLEAN_TRUE : Types.BOOLEAN_FALSE);
                _booleanField = null;
            }
            else
            {
