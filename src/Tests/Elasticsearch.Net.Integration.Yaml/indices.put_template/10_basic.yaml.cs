...
namespace ES.Net.Integration.Yaml.IndicesPutTemplate1
{
	...
	{	
		...
		[NCrunch.Framework.ExclusivelyUses("ElasticsearchYamlTests")]
		public class PutTemplateCreate3Tests : YamlTestsBase
		{
			[Test]
			public void PutTemplateCreate3Test()
			{	
				...
				this.Do(()=> _client.IndicesPutTemplateForAll("test", _body, nv=>nv
					.AddQueryString("create", @"true")
				));
