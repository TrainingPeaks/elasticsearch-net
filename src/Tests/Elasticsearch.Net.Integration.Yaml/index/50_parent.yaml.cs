...
namespace ES.Net.Integration.Yaml.Index9
{
	public partial class Index9YamlTests
	{	
		...
		public class Parent1Tests : YamlTestsBase
		{
			...
			{	
				...
				this.Do(()=> _client.Index("test_1", "test", "1", _body), shouldCatch: @"/RoutingMissingException/");
